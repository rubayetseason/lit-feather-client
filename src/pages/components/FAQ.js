...
const FAQ = () => {
  return (
    <Container>
      ...
      <div>
        <h5>
          <SlQuestion /> How many courses does Lit-feather have?
        </h5>
      ...
      <div>
        <h5>
          <SlQuestion /> What do I need to register in the courses of Lit-feather?
        </h5>
        <p className='text-start'><small>One only needs his email and picture link to enroll into any of our courses.</small></p>
      </div>
      <div>
        <h5>
          <SlQuestion /> Are the courses here worth the time and money?
        </h5>
      ...
      <div>
        <h5>
          <SlQuestion /> What are the advantages provides when enrolled into one course?
        </h5>
